...
// Config file strings
#define TEXT_CNF_DEFGPS     "GPS"  // when using just NMEA data this simply was the COM port ... now replaced with:
#define TEXT_CNF_DEFPTP     "GPS PortType"    // Port type (NMEA, GarCOM, GarUSB)
#define TEXT_CNF_DEFPNM     "GPS PortName"    // Identifier string for port type
#define TEXT_CNF_DEFDNM     "GPS DeviceName"  // Device name if known
#define TEXT_CNF_DEFDID     "GPS DeviceID"    // Device ID if known
