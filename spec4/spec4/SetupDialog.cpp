...
BOOL CSetupDialog::OnInitDialog()
{
	...
	{
		c_SetupGPS.AddString(ports[ii].GetBuffer());
	}
...
void CSetupDialog::OnBnClickedTestGps()
{
	...
	if (theApp.pGarminPort->setGarminPort(tval) && 
