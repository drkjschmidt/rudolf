// sditest.cpp : Defines the class behaviors for the application.
//
...
// CsditestApp message handlers


BOOL CsditestApp::PreTranslateMessage(MSG* pMsg)
{
	// TODO: Add your specialized code here and/or call the base class
	if (CSplashDialog::PreTranslateAppMessage(pMsg))
		return true;

	// CODE that never goes away ... ?!?
	switch (pMsg->message) {
		case WM_SIZE:
		case WM_SIZING:
		case WM_MOVE:
		...
		case WM_WINDOWPOSCHANGED:
			((CMainFrame *)AfxGetMainWnd())->ChangeStatusText("Window resized");
			break;		
		case WM_KEYDOWN:
		case WM_SYSKEYDOWN:
		case WM_LBUTTONDOWN:
		...
		case WM_NCMBUTTONDOWN:
			((CMainFrame *)AfxGetMainWnd())->ChangeStatusText("Peeks and Pokes");
			break;		
		default:
			break;
	}
